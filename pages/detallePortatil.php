...
<?php
    ...
    if (is_numeric($id_p)) {
        $portatil = "SELECT * FROM grupo_portatiles where id = ".$id_p; 
        $detallePortatil = $mysqli->query($portatil);
    } else {
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto nav-pills">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="nosotros.html" id="activo">Acerca de</a>
                </li>
                <li class="nav-item" id="navbar-nav">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
                <?php
                    while($mostrarInfo = $detallePortatil->fetch_assoc()){
				echo '<h4>'.$mostrarInfo['nombre'].' '.$mostrarInfo['modelo'].' '.$mostrarInfo['sistema_operativo'].'</h4>
				    <p>Marca: '.$mostrarInfo['marca'].' |  Color: '.$mostrarInfo['color'].'</p>
                <hr>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<ul style="list-style: circle;  font-size: 16px; padding-left: 40px;">
					...
					<li>Sistema operativo:  '.$mostrarInfo['sistema_operativo'].'</li>
					<li>Procesador:  '.$mostrarInfo['procesador'].'</li>
					<li>Memoria RAM:  '.$mostrarInfo['memoria'].'</li>
					<li>Disco Duro:  '.$mostrarInfo['disco_duro'].'</li>
					<li>Pantalla:  '.$mostrarInfo['pantalla'].'</li>
					<li>Resolucion: '.$mostrarInfo['resolucion'].'</li>
					<li>Peso:   '.$mostrarInfo['peso'].'</li>
					<li>Conectividad:  '.$mostrarInfo['conectividad'].'</li>
			...
			<div class="col-md-3">
				...
				<ul style="list-style: none;">
					...
					<li style="padding: 5px;">Cantidad: '.$mostrarInfo['cantidad'].'</li>
					<button type="button" class="btn btn-success icon-basket" style="padding: 5px;"> Añadir al carrito</button>
				</ul>
		...
		<div class="row">
            <div class="col-md-8">
                <ul style="list-style: none;">
                    ...
                    <li><span style="font-weight: bold">'.$mostrarInfo['nombre'].'</span>
				...
				<table class="table table-striped" style="font-size: 14px;">
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td>'.$mostrarInfo['modelo'].'</td>
				    </tr>

				    <tr>
				      <th colspan="4">Pantalla</th>
				      <td>'.$mostrarInfo['pantalla'].'</td>
				    </tr>

				    <tr>
				      <th colspan="4">Tamaño de Pantalla</th>
				      <td>'.$mostrarInfo['pulgada'].'</td>
				    </tr>
                    <tr>
                      <th colspan="4">Resolucion</th>
                      <td>'.$mostrarInfo['resolucion'].'</td>
                    </tr>

				    <tr>
				      <th colspan="4">Color</th>
				      <td>'.$mostrarInfo['color'].'</td>
				    </tr>
                    <tr>
                      <th colspan="4">Peso</th>
                      <td>'.$mostrarInfo['peso'].'</td>
                    </tr>
                    <tr>
                      <th colspan="4">Disco Duro</th>
                      <td>'.$mostrarInfo['disco_duro'].'</td>
                    </tr>
                    <tr>
                      <th colspan="4">Conectividad</th>
                      <td>'.$mostrarInfo['conectividad'].'</td>
                    </tr>
                    <tr>
                      <th colspan="4">Bateria</th>
                      <td>'.$mostrarInfo['bateria'].'</td>
                    </tr>
                    <tr>
                      <th colspan="4">Tipo de bateria</th>
                      <td>'.$mostrarInfo['tipo_bateria'].'</td>
                    </tr>
                     <tr>
                      <th colspan="4">Condición</th>
                      <td>'.$mostrarInfo['condicion'].'</td>
                    </tr>
