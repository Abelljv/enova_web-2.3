    ...
    <td><form id="formUsuarios" name="formUsuarios" method="post" action="guardarUsuarios.php">
      ...
      <table width="700" border="0">
        <tr>
          ...
          <td width="200" align="left" class="com">Nombre (Alias):</td>
      ...
      <table width="700" border="0">
        <tr>
          ...
          <td size="50"><label for="repitaPassword"></label>
            <input name="repitaPassword" type="password" id="repitaPassword" size="50" /></td>
        </tr>
    </table>
      <table width="700" border="0">
        <tr>
          <td width="70" align="center" class="com">&nbsp;</td>
          <td width="200" align="left" class="com">Nombre:</td>
      ...
      <table width="700" border="0">
        <tr>
          <td width="70" align="center" class="com">&nbsp;</td>
          <td width="200" align="left" class="com">Apellidos:</td>
