...
<body>
   ...
   $query = "select * from finan_articulo";
    ...
    <div class="container">
            <form  method="POST" enctype="multipart/form-data" action="../../modulos/procesos/actualizarInfoCreditos.php">
             ...
             <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre"value="<?php echo $row['nombrec']; ?>"">
                    </div>
                </div>
