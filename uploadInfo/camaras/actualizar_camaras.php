...
<body>
    ...
    <?php
        ...
        @$id = $_GET['id'];
        $Consulta = "select A.*, B.nombre as id_nom from grupo_camaras A inner join categorias B on A.id_categoria = B.id_categoria where A.id = $id";
     ...
     ?>
    <div class="container">
            <form  method="post" enctype="multipart/form-data" action="../../modulos/procesos/actualizarInfoCamaras.php">
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="led" name="led" required="" value="<?php echo $row['led']; ?>">
                    </div>
                  </div>
            </div>
