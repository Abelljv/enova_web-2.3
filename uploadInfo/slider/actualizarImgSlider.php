...
<body>
    ...
    <?php
        ...
        @$id = $_GET['id'];
        $Consulta = "select * from slider_home  where id = $id";
     ...
     ?>
    <div class="container">
            <form  method="post" enctype="multipart/form-data" action="../../modulos/procesos/actualizarSlider.php">
                <h3>IMAGEN DEL SLIDER - (Pagina principal)</h3>
