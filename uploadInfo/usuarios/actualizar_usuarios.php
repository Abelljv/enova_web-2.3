...
<body>
    ...
    <div class="container">
        ...
        <fieldset class="scheduler-border">
          <legend class="scheduler-border">Información de usuarios:</legend>
  ...
  <div class="row">
                ...
                <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="ContraseñadeUsuario" name="ContraseñadeUsuario" placeholder="Contraseña de Usuario" value="<?php echo $row['password']; ?>" required="">
                     </div>
                </div>
                <div class="col-md-4">
                     <div class="form-group">
