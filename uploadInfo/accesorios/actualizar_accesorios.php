...
<body>
    ...
    <?php
        ...
        @$id = $_GET['id'];
        $Consulta = "select A.*, B.nombre as id_nom from grupo_accesorios A inner join categorias B on A.id_categoria = B.id_categoria where A.id = $id";
     ...
     ?>
    <div class="container">
            <form  method="post" enctype="multipart/form-data" action="../../modulos/procesos/actualizarInfoAccesorios.php">
                <h3>INGRESO DE INFORMACIÓN DEL PRODUCTO - (Accesorios de computadores)</h3>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['id']; ?>" >
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" required="" title="Se requiere un nombre" value="<?php echo $row['nombre']; ?>">
                    </div>
                </div>
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="material" name="material" required="" value="<?php echo $row['material']; ?>">
                    </div>
                  </div>
            </div>
            <div class="row">
        ...
        <div class="row boton">
             <div class="col-md-12">
                    <div class="form-group">
                        <button type="submit" class="btn btn-success button icon-upload" required> Actualizar información</button>
                    </div>
                </div>
        </div>
    ...
    <script src="../../assets/js/previsualizacion/"></script>
</body>
<!-- Abell && favian -->
</html>