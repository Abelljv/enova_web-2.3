...
<?php
    ...
    if (is_numeric($id_p)) {
        $producto = "SELECT * FROM grupo_computadores where id = ".$id_p; 
			...
			<div class="col-md-4">
              ...
              <br>
				<ul style="list-style: circle;  font-size: 16px; padding-left: 40px;">
                    ...
                    <li>Placa base:  '.$mostrarInfo['board'].'</li>
					<li>Procesador:  '.$mostrarInfo['procesador'].'</li>
					<li>Memoria RAM:  '.$mostrarInfo['memoria'].'</li>
					<li>Disco Duro:  '.$mostrarInfo['disco_duro'].'</li>
					<li>Monitor:  '.$mostrarInfo['monitor'].'</li>
                    <li>Puerto:  '.$mostrarInfo['puertos'].'</li>
                    <li>Fuente:  '.$mostrarInfo['fuente'].'</li>
				...
				<table class="table table-striped" style="font-size: 14px;">
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td>'.$mostrarInfo['monitor'].'</td>
				    </tr>
                        <tr>
                      <th colspan="4">Teclado</th>
                      <td>'.$mostrarInfo['teclado'].'</td>
                    </tr>
                       <tr>
                      <th colspan="4">Mouse</th>
                      <td>'.$mostrarInfo['mouse'].'</td>
                    </tr>
