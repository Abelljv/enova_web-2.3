...
<?php
    ...
    if (is_numeric($id_p)) {
        $producto = "SELECT * FROM grupo_camaras where id = ".$id_p; 
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                echo '<h4>'.$mostrarInfo['nombre'].' '.$mostrarInfo['modelo'].' '.$mostrarInfo['marca'].' </h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <ul style="list-style: circle;  font-size: 16px; padding-left: 40px;">
                    ...
                    <li>Modelo:  '.$mostrarInfo['modelo'].'</li>
                    <li>LEDS:  '.$mostrarInfo['led'].'</li>
                    <li>Material:  '.$mostrarInfo['material'].'</li>
                    <li>Color: '.$mostrarInfo['color'].'</li>
                    <li>Condicion:   '.$mostrarInfo['condicion'].'</li>
            ...
            <div class="col-md-4">
                ...
                <table class="table table-striped" style="font-size: 14px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th colspan="4">IR LEDS</th>
                      <td>'.$mostrarInfo['led'].'</td>
                    </tr>
                    <tr>
                      <th colspan="4">Resolucion</th>
                      <td>'.$mostrarInfo['resolucion'].'</td>
